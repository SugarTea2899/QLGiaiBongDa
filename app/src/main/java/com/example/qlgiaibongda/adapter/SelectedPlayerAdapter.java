...
public class SelectedPlayerAdapter extends RecyclerView.Adapter<SelectedPlayerAdapter.SelectPlayer> {

    private ArrayList<Player> listPlayer;
    private Context context;

    public SelectedPlayerAdapter(Context context, ArrayList<Player> list){
    ...
    public SelectPlayer onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.selected_player_item, parent, false);
